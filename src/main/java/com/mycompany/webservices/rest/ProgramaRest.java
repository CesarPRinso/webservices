...
public class ProgramaRest {
    ...
    ProgramaService programaService;
      ...
      @ResponseBody
    @RequestMapping(value = "programa", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ResponseBody
    @RequestMapping(value = "programa/{id}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "programa/save", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ResponseBody
    @RequestMapping(value = "programa/save", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
